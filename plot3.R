...
###   Description: Create multi-line plot with legend and save as PNG file.
###   -------------------------------------------------------------------
...
###   Create PNG file of plot and save to working directory.
      ...
      with(tidy, plot(tidy$dateTime, tidy$subMetering1, type ="n", main = "", xlab="", ylab ="Energy sub metering"))
