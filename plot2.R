...
###   Description: Create line plot and save as PNG file.
###   ---------------------------------------------------------------
...
###   Create PNG file of plot and save to working directory
      ...
      with(tidy, plot(tidy$dateTime, tidy$globalActivePower, type ="n", main = "", xlab="", ylab ="Global Active Power (kilowatts)"))
